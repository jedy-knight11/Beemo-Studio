...
const servicesData = [
  {
    ...
    icon: <Video size={24} />,
    image: (import.meta as any).env.BASE_URL + '/services/institucional.webp'.substring(1)
  },
  {
    id: 'comerciales',
    ...
    image: (import.meta as any).env.BASE_URL + '/services/comercial.webp'.substring(1)
  },
  {
    id: 'cobertura',
    ...
    image: (import.meta as any).env.BASE_URL + '/services/eventos.webp'.substring(1)
  },
  {
    id: 'casos',
    ...
    image: (import.meta as any).env.BASE_URL + '/services/casos.webp'.substring(1)
  }
];
