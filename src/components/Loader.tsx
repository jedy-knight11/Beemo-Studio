...
export const Loader = ({ onLoadingComplete }: { onLoadingComplete: () => void }) => {
  ...
  return (
    ...
    >
      ...
      >
        <img src={(import.meta as any).env.BASE_URL + '/logo.png'.substring(1)} alt="Beemo Studio Loading" className="w-full h-auto object-contain drop-shadow-[0_0_15px_rgba(8,62,235,0.5)]" />
      </motion.div>
