      ...
      <div ref={containerRef} className="hidden lg:block relative h-[300vh]">
        <div className="sticky top-0 h-screen w-full flex items-center overflow-hidden">
          ...
          <div className="w-full max-w-[1800px] mx-auto px-12 xl:px-24 grid grid-cols-12 gap-12 xl:gap-24 items-center">
            ...
            <div className="col-span-7 relative h-[60vh] flex items-center justify-start border-l-2 border-[#083eeb] pl-16">
               {steps.map((step, i) => (
...
console.log('Process.tsx reverted to Sticky Scroll Fade Animation layout.');
